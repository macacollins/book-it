...
export class LichessClient {
  ...
  private async makeRequest<T>(
    ...
    if (contentType && contentType.includes("application/x-ndjson")) {
      ...
      const resultLines: T[] = split.map(
        (line) => JSON.parse(line) as unknown as T,
      );
   ...
   */
  async apiAccountPlaying(options?: {
    nb?: number;
  }): Promise<{
    nowPlaying: {
      fullId: string;
  ...
  async resultsByTournament(
    id: string,
    options?: { nb?: number; sheet?: boolean },
  ): Promise<{
    rank: number;
    score: number;
    rating: number;
    ...
    if (options?.sheet !== undefined)
      queryParams.append("sheet", String(options?.sheet));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/tournament/${id}/results?${queryString}`
  ...
  async teamsByTournament(
    ...
    teams: {
      ...
      id: string;
      score: number;
      players: { user: LightUser; score?: number }[];
    }[];
  }> {
  ...
  async apiUserNameTournamentCreated(
    username: string,
    options?: { nb?: number; status?: "10" | "20" | "30" },
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/user/${username}/tournament/created?${queryString}`
  ...
  async apiUserNameTournamentPlayed(
    username: string,
    options?: { nb?: number; performance?: boolean },
  ): Promise<ArenaTournamentPlayed> {
    const queryParams = new URLSearchParams();
    if (options?.nb !== undefined)
      queryParams.append("nb", String(options?.nb));
    if (options?.performance !== undefined)
      queryParams.append("performance", String(options?.performance));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/user/${username}/tournament/played?${queryString}`
  ...
  async gamesBySwiss(
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/swiss/${id}/games?${queryString}`
      : `/api/swiss/${id}/games`;
    const headers: Record<string, string> = {};
    return this.makeRequest<GameJson>(fullPath, "GET", headers);
  }
  ...
  async resultsBySwiss(
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/swiss/${id}/results?${queryString}`
  ...
  async apiTeamSwiss(
    ...
    if (options?.createdBy !== undefined)
      queryParams.append("createdBy", String(options?.createdBy));
    if (options?.name !== undefined)
      queryParams.append("name", String(options?.name));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/team/${teamId}/swiss?${queryString}`
  ...
  async studyChapterPgn(
    ...
    if (options?.comments !== undefined)
      queryParams.append("comments", String(options?.comments));
    if (options?.variations !== undefined)
      queryParams.append("variations", String(options?.variations));
    if (options?.orientation !== undefined)
      queryParams.append("orientation", String(options?.orientation));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/study/${studyId}/${chapterId}.pgn?${queryString}`
  ...
  async studyAllChaptersPgn(
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/study/${studyId}.pgn?${queryString}`
  ...
  async apiStudyImportPGN(studyId: string): Promise<StudyImportPgnChapters> {
    ...
    const headers: Record<string, string> = {};
    return this.makeRequest<StudyImportPgnChapters>(
      fullPath,
      "POST",
      {},
      headers,
  ...
  async studyExportAllPgn(
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/study/by/${username}/export.pgn?${queryString}`
   ...
   */
  async apiStudyStudyIdChapterIdDelete(
    studyId: string,
    chapterId: string,
  ): Promise<void> {
   ...
   */
  async broadcastsOfficial(options?: {
    nb?: number;
    html?: boolean;
  }): Promise<BroadcastWithRounds> {
    const queryParams = new URLSearchParams();
    if (options?.nb !== undefined)
      queryParams.append("nb", String(options?.nb));
    if (options?.html !== undefined)
      queryParams.append("html", String(options?.html));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/broadcast?${queryString}`
      : `/api/broadcast`;
    const headers: Record<string, string> = {};
   ...
   */
  async broadcastsTop(options?: {
    page?: number;
    html?: boolean;
  }): Promise<BroadcastTop> {
    const queryParams = new URLSearchParams();
    if (options?.page !== undefined)
      queryParams.append("page", String(options?.page));
    if (options?.html !== undefined)
  ...
  async broadcastsByUser(
    username: string,
    options?: { page?: number; html?: boolean },
  ): Promise<{
    currentPage: number;
    maxPerPage: number;
    currentPageResults: BroadcastByUser[];
    nbResults: number;
    previousPage: any;
    nextPage: any;
    nbPages: number;
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/broadcast/by/${username}?${queryString}`
   ...
   * Search broadcasts
   */
  async broadcastsSearch(options?: {
    page?: number;
    q?: string;
  }): Promise<{
    currentPage: number;
    ...
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/broadcast/search?${queryString}`
   ...
   */
  async broadcastPlayersGet(
    broadcastTournamentId: string,
  ): Promise<BroadcastPlayerEntry[]> {
   ...
   */
  async broadcastPlayerGet(
    broadcastTournamentId: string,
    playerId: string,
  ): Promise<BroadcastPlayerEntryWithFideAndGames> {
    const fullPath = `/broadcast/${broadcastTournamentId}/players/${playerId}`;
    const headers: Record<string, string> = {};
    return this.makeRequest<BroadcastPlayerEntryWithFideAndGames>(
      fullPath,
      "GET",
      headers,
    );
   ...
   */
  async broadcastMyRoundsGet(options?: {
    nb?: number;
  }): Promise<BroadcastMyRound> {
    const queryParams = new URLSearchParams();
    if (options?.nb !== undefined)
      queryParams.append("nb", String(options?.nb));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/broadcast/my-rounds?${queryString}`
   ...
   */
  async apiCloudEval(options: {
    fen: string;
    multiPv?: number;
    variant?: VariantKey;
  }): Promise<CloudEval> {
    const queryParams = new URLSearchParams();
    if (options.fen !== undefined)
      queryParams.append("fen", String(options.fen));
    if (options?.multiPv !== undefined)
      queryParams.append("multiPv", String(options?.multiPv));
    if (options?.variant !== undefined)
      queryParams.append("variant", String(options?.variant));
    const queryString = queryParams.toString();
    const fullPath = queryString
      ? `/api/cloud-eval?${queryString}`
      : `/api/cloud-eval`;
    const headers: Record<string, string> = {};
   ...
   */
  async apiExternalEngineAnalyse(body: {
    clientSecret: string;
  ...
  async oauth(options: {
    ...
    if (options?.response_type !== undefined)
      queryParams.append("response_type", String(options?.response_type));
    if (options?.client_id !== undefined)
      queryParams.append("client_id", String(options?.client_id));
    if (options?.redirect_uri !== undefined)
      queryParams.append("redirect_uri", String(options?.redirect_uri));
    if (options?.code_challenge_method !== undefined)
      queryParams.append(
        "code_challenge_method",
        String(options?.code_challenge_method),
      );
    if (options?.code_challenge !== undefined)
      queryParams.append("code_challenge", String(options?.code_challenge));
    if (options?.scope !== undefined)
      queryParams.append("scope", String(options?.scope));
    if (options?.username !== undefined)
      queryParams.append("username", String(options?.username));
    if (options?.state !== undefined)
      queryParams.append("state", String(options?.state));
    const queryString = queryParams.toString();
   ...
   */
  async tokenTest(): Promise<{
    [key: string]: { userId?: string; scopes?: string; expires?: any } | any;
  }> {
    const fullPath = `/api/token/test`;
    const headers: Record<string, string> = {};
    return this.makeRequest<{
      [key: string]: { userId?: string; scopes?: string; expires?: any } | any;
    }>(fullPath, "POST", {}, headers);
  }

  /**
   * Masters database
   */
  async openingExplorerMaster(options?: {
    fen?: string;
    play?: string;
    since?: number;
    until?: number;
    moves?: number;
    topGames?: number;
  }): Promise<OpeningExplorerMasters> {
    const queryParams = new URLSearchParams();
    if (options?.fen !== undefined)
      queryParams.append("fen", String(options?.fen));
    if (options?.play !== undefined)
      queryParams.append("play", String(options?.play));
    if (options?.since !== undefined)
      queryParams.append("since", String(options?.since));
    if (options?.until !== undefined)
      queryParams.append("until", String(options?.until));
    ...
    if (options?.topGames !== undefined)
      queryParams.append("topGames", String(options?.topGames));
    const queryString = queryParams.toString();
    const fullPath = queryString ? `/masters?${queryString}` : `/masters`;
    const headers: Record<string, string> = {};
    return this.makeRequest<OpeningExplorerMasters>(
      fullPath,
      "GET",
      headers,
      {},
   ...
   * Lichess games
   */
  async openingExplorerLichess(options?: {
    variant?: VariantKey;
    fen?: string;
    play?: string;
    speeds?: Speed[];
    ...
    recentGames?: number;
    history?: boolean;
  }): Promise<OpeningExplorerLichess> {
    const queryParams = new URLSearchParams();
    if (options?.variant !== undefined)
      queryParams.append("variant", String(options?.variant));
    if (options?.fen !== undefined)
    ...
    if (options?.play !== undefined)
      queryParams.append("play", String(options?.play));
    if (options?.speeds !== undefined)
      queryParams.append("speeds", String(options?.speeds));
    if (options?.ratings !== undefined)
      queryParams.append("ratings", String(options?.ratings));
    if (options?.since !== undefined)
      queryParams.append("since", String(options?.since));
    if (options?.until !== undefined)
      queryParams.append("until", String(options?.until));
    ...
    if (options?.recentGames !== undefined)
      queryParams.append("recentGames", String(options?.recentGames));
    if (options?.history !== undefined)
      queryParams.append("history", String(options?.history));
    const queryString = queryParams.toString();
    const fullPath = queryString ? `/lichess?${queryString}` : `/lichess`;
    const headers: Record<string, string> = {};
    return this.makeRequest<OpeningExplorerLichess>(
      fullPath,
      "GET",
      headers,
      {},
   ...
   * Player games
   */
  async openingExplorerPlayer(options: {
    player: string;
    color: "white" | "black";
    variant?: VariantKey;
    fen?: string;
    ...
    if (options?.modes !== undefined)
      queryParams.append("modes", String(options?.modes));
    if (options?.since !== undefined)
      queryParams.append("since", String(options?.since));
    if (options?.until !== undefined)
      queryParams.append("until", String(options?.until));
   ...
   * Tablebase lookup
   */
  async tablebaseStandard(options: {
    fen: string;
    dtc?: "never" | "auxiliary" | "always";
  }): Promise<TablebaseJson> {
    const queryParams = new URLSearchParams();
    if (options.fen !== undefined)
      queryParams.append("fen", String(options.fen));
    if (options?.dtc !== undefined)
      queryParams.append("dtc", String(options?.dtc));
    const queryString = queryParams.toString();
