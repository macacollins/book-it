...
export default function processNewRepertoire(
  fileContents,
  {
    repertoire,
    setRepertoire,
  ...
  console.debug(
    "Setting current repertoire to new repertoire ",
    newRepertoireNameField,
  );
  ...
  const newRepertoireList =
    repertoireList && repertoireList.length
      ? [...repertoireList, newRepertoireNameField]
      : [newRepertoireNameField];
