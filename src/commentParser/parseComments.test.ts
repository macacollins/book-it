...
test("Basic test before and after text", () => {
    let pgnResults = parseComments("The line is 1.e4 e5 2.c4 c5 after that.", basicGame);
...
test("Basic test with FEN", () => {
    let pgnResults = parseComments("The line is @@StartFEN@@rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1@@EndFEN@@ 1...e5 2.c4 c5 after that.", basicGame);
...
test("Alternate Move Option for main line second move", () => {
    let pgnResults = parseComments("An alternative is 2.Nc3", pgnParser.parse("1.e4 c5 2.d4 *")[0]);
...
test("Multiple Alternate Move Options", () => {
    let pgnResults = parseComments("Alternatives include 2.Nc3 and 2.e5", pgnParser.parse("1.e4 c5 2.d4 *")[0]);
...
test("Multiple Alternate Move Options with comma", () => {
    let pgnResults = parseComments("Alternatives include 2.Nc3 and 2.b4 and 2.e5", pgnParser.parse("1.e4 c5 2.d4 *")[0]);
