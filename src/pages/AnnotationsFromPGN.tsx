...
export default function Annotations({
  ...
  const fens = moves?.map((move: string) => {
  ...
  let total = Object.values(wordCount).reduce(
  ...
  const levels = [
    0, 300, 900, 2700, 6500, 13000, 23000, 34000, 48000, 64000, 85000, 100000,
    120000, 195000, 225000, 265000, 305000, 355000,
  ];
      ...
      <Splitter layout="vertical">
        ...
        <SplitterPanel className="flex flex-column">
              ...
              <>
                <div className="flex gap-1 justify-content-center">
                  ...
                  <Button
                    ...
                    label="l"
                    onClick={() => {
                      window.open(`https://lichess.org/${fen}`, "_blank");
                    }}
                  />
          ...
          <div>
            ...
            {thisWordCount > 1000 ? (
              <Badge value="1000+" severity="success"></Badge>
            ) : (
              ""
            )}
          </div>
