...
describe('MoveTree', () => {
  ...
  describe('createMoveTree', () => {
    ...
    it('should create a move tree with name and headers', () => {
      const headers = { Event: 'World Championship', White: 'Player1', Black: 'Player2' };
  ...
  describe('addStartNode', () => {
    ...
    it('should add multiple start nodes', () => {
      ...
      tree = addStartNode(tree, 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1', 'After 1.e4');
  ...
  describe('addMoveNode', () => {
    ...
    it('should add multiple moves in sequence', () => {
      ...
      const afterNf3FEN = 'rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2';
      ...
      expect(tree.nodes[0].children[0].children[0].children[0].move).toBe('Nf3');
    });
    ...
    it('should add variations (multiple children)', () => {
      ...
      const afterE4FEN = 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq e3 0 1';
      const afterE5FEN = 'rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq e6 0 2';
      const afterC5FEN = 'rnbqkbnr/pp1ppppp/8/2p5/4P3/8/PPPP1PPP/RNBQKBNR w KQkq c6 0 2';
  ...
  describe('JSON serialization', () => {
    it('should convert tree to JSON and back', () => {
      const headers = { Event: 'Test Tournament', White: 'Player1', Black: 'Player2' };
