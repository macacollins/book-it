...
const ChessBoardLoader: React.FC<ChessBoardLoaderProps> = ({ children }) => {
  ...
  const loadChessBoardDependencies = () => {
    ...
    const chessBoardCSSURL = new URL(
      "../chessboard-1.0.0.min.css",
      import.meta.url,
    ).href;
    const chessboardJSURL = new URL(
    ...
    let jqueryScriptTag = document.getElementById(
      "jquery-script",
    ) as HTMLScriptElement;
    let chessboardJSScriptTag = document.getElementById(
      "chessboard-js-script",
    ) as HTMLScriptElement;
    let chessboardCSSLinkTag = document.getElementById(
      "chessboard-css-link",
    ) as HTMLLinkElement;
