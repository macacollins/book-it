  ...
  return (
    <div>
      <Splitter className="mb-3">
        ...
        <SplitterPanel
          className="flex align-items-start justify-content-center"
          size={50}
        >
      ...
      <div className="mt-3 p-3 bg-gray-100 border-round">
        ...
        <ul className="pl-4">
          ...
          <li>
            <strong>Notes tab:</strong> Enter notes in the text area (auto-saved
            after 1 second)
          </li>
          <li>
            <strong>Masters tab:</strong> View statistics from the Lichess
            masters database
          </li>
          <li>
            <strong>Lichess Stats tab:</strong> View statistics from Lichess
            games (1600-2000 rated players)
          </li>
          <li>
            All data is loaded automatically when you change the FEN position
          </li>
        </ul>
      </div>
    </div>
